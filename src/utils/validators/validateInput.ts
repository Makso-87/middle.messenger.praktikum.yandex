const rules = {
  ...
  email: /[a-z0-9-_]@[a-z]{3,}.[a-z]+/, // латиница, может включать цифры и спецсимволы вроде дефиса, обязательно должна быть «собака» (@) и точка после неё, но перед точкой обязательно должны быть буквы.
...
export const errorsMessages = {
  ...
  email: 'Допустимы символы "a-z 0-9 - _". Обязательно должен быть символ @.',
